                            ...
                            <ol>
                                <li>
                                    ...
                                    <button type="button" class="btn btn-lg"
                                        data-toggle="modal" data-target="#start_login" id="boton2">Iniciar sesión
                                    </button>
...
?>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-body modal_recovery">
                                    ...
                                    <br><br>
                                    <p class="recovery_text">Se le hará envío de un código con el cual podrá definir una nueva contraseña para su cuenta.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container py-3">
            ...
            <div class="col-sm">
                ...
                <div class="card-deck py-3">
                    <div class="card objectives_container">
                        <div class="card-body">
                            <h3 class="card-title card-footer text-center border border-dark objectives_titles">Misión
                            </h3>
        ...
        <div class="container text-center">
            <h2 class="card-title text-center main_titles"><strong>¿Qué elementos hemos
                    utilizado?</strong>
            </h2>
    ...
    <footer>
        <div class="container-fluid index_footer">
            <div class="row text-center py-3">
                <div class="col-xl-2 about_software"><span><button type="button" class="btn btn-primary"
