...
<!-- Se crea una barra de navegación que ocupa todo el ancho del contenedor: -->
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="navbar-collapse">
                       ...
                       <?php 
                       //Se muestra el nombre y apellido del administrador que inició sesión.
                       echo $_SESSION['nombre_administrador']; ?> </h2>
                   </div>
                </nav>
            </div>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup" >
            ...
            <div class="container-fluid container_options">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="sign_up.php">
                        <!-- Se crea un botón que dirige a una nueva pestaña para registrar un nuevo usuario -->
...
<!-- Estructura de la ventana modal tipo 'fade' de  Agregar/Eliminar fichas-->
            <div class="modal fade" id="modal_add_delete" tabindex="-1" role="dialog" aria-labelledby="modal_add_delete" aria-hidden="true">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <!-- Se crea el botón con el que se cierra la ventana modal: -->
                            ...
                            <div class="table-responsive-xl">
                                ...
                                <table class="table table-hover text-center">
                                    ...
                                    <tbody>
                                        <!-- Se comienzan a mostrar la información de cada columna -->
                                        <tr>
                        ...
                        <!-- Se egrega un botón que agregará una ficha -->
